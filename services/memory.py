...
TOPIC_KEYWORDS: dict[str, list[str]] = {
    "отношения": [
        "отношения", "любовь", "партнёр", "муж", "жена",
        "парень", "девушка", "расставание", "разрыв", "чувства",
    ],
    "работа": [
        "работа", "карьера", "деньги", "бизнес",
        "начальник", "увольнение", "проект", "профессия", "зарплата",
    ],
    "выбор": [
        "выбор", "решение", "не знаю", "куда", "как поступить",
        "дилемма", "сомнение", "колеблюсь",
    ],
    "здоровье": [
        "здоровье", "болезнь", "состояние", "самочувствие", "лечение",
    ],
    "семья": [
        "семья", "родители", "дети", "мама", "папа", "ребёнок",
